#!/bin/sh
# dlctl - swap PDP-11 disk images at runtime through pdp11-hostd's REST API.
# Covers both busses: RL11 (DL0..DL3) and RH11/RP06 (DB0, one drive only).
# (pdp11-hostd also serves the XU network bridge, but that has no REST
# surface - nothing to swap live there.)
#
